    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item">
            <a href="deletebook.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Delete Book</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
include_once "delete.php";
            ...
            $getdelete = new getdeleteevent();
                        $records = $getdelete->getAllRecords($conn);
